...
<body class="bg-[#1e1e1e] text-[#d4d4d4] antialiased font-sans flex flex-col min-h-screen">
    ...
    <div id="lightbox" class="fixed inset-0 z-[100] bg-black/90 hidden opacity-0 transition-opacity duration-300 flex items-center justify-center p-4">
        <button id="lightbox-close" class="absolute top-6 right-6 text-white hover:text-[#d4d4d4] transition-colors z-[101]">
